...
ak_engine = create_engine('mysql+pymysql://root:123456@localhost:3306/akshare_db?charset=utf8mb4')
#交易所期货数据
futures_exchange_data=['get_cffex_daily','get_cffex_rank_table','get_czce_daily','get_czce_rank_table','get_dce_daily','get_ine_daily','futures_sgx_daily','get_dce_rank_table','get_futures_daily','get_rank_sum','get_rank_sum_daily','futures_dce_position_rank','get_receipt','get_roll_yield','get_roll_yield_bar','get_shfe_daily','get_shfe_rank_table','get_shfe_v_wap','futures_spot_price','futures_spot_price_daily','futures_czce_warehouse_receipt','futures_shfe_warehouse_receipt''futures_dce_warehouse_receipt','futures_rule']
#奇货可查数据
qhkc=['get_qhkc_index','get_qhkc_index_profit_loss','get_qhkc_index_trend','get_qhkc_fund_bs','get_qhkc_fund_position','get_qhkc_fund_position_change','get_qhkc_tool_foreign','get_qhkc_tool_gdp']
# 中国银行间市场交易所数据
bank_market_data=["get_bond_bank"] 
# # 智道智科-私募指数数据
